# setup_auth_forecast_full.py (part 1)

import os
# Updated forecast.py with safe model handling and string casting
with open("forecast.py", "w") as f:
    f.write('''from prophet import Prophet
...
"✅ forecast.py updated with safe string handling, support for prophet/arima/auto, and proper plotting."
